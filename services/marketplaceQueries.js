...
module.exports = {
    ...
    insertSellTransactionByItemId : "INSERT INTO transaction (gas_fee,user_id,item_id,item_edition_id,transaction_type_id,amount,currency,status,user_address,commission_percent,commission) select ?, ie.owner_id,i.id,ie.id as item_edition_id,1 as transaction_type_id, ? as price,'USD' AS currency,1,?,?,?  from item_edition as ie left join item as i on i.id=ie.item_id where ie.id=?",
